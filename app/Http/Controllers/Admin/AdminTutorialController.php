...
class AdminTutorialController extends Controller
{
    public function index(){
        ...
        return view('admin.designation.index', compact('tutorials'));
    }
    public function create(){
        $categories = Category::all();
        $users = User::all();
        return view ('admin.designation.create', compact('categories','users'));
    }
    ...
    public function edit($slug){
        ...
        $users = User::all();
        $categories = Category::all();
        return view ('admin.designation.edit', compact('tutorial', 'uploads', 'users', 'categories'));
    }
